  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="资产原值">
        <el-input v-model="asset.netValue" />
      </el-form-item>
      <el-form-item label="规格">
         <el-input v-model="asset.specification" />
      </el-form-item>
      <el-form-item label="品牌 型号">
          <el-input v-model="asset.brandModel" />
      </el-form-item>
      <el-form-item label="物品图示">
        <el-upload :show-file-list="false" :on-success="handleCoverSuccess" :before-upload="beforeCoverUpload"
          ...
          :action="upload">
          <img v-if="asset.cover" :src="assetVo.asset.assetPhoto">
      ...
      <el-form-item label="使用人">
        <el-input v-model="asset.asset.uerNumber" />
      </el-form-item>
      <el-form-item label="部门单位">
        <el-input v-model="asset.asset.apartmentId" />
      </el-form-item>
...
export default {
  ...
  created() {
    ...
    this.assetVo.asset.id = this.$route.query.id
    if (this.assetVo.asset.id) { this.init() }
  },
  methods: {
    initCategoryList() {
    ...
    init() {
      assetApi.getAssetById(this.assetVo.asset.id).then(response => {
