...
export const constantRoutes = [
  ...
  {
    path: '/asset_infomation',
    component: Layout,
    redirect: '/asset_information/list',
    name: 'AssetInformation',
    meta: { title: '资产信息', icon: 'el-icon-s-help' },
    children: [
      {
        path: '/asset_infomation/list',
        name: 'AssetInformationList',
        component: () => import('@/views/asset_information/list/index'),
        meta: { title: '资产信息列表', icon: 'table' }
      },
      {
        path: '/asset_infomation/add',
        name: 'AssetInformationAdd',
    ...
    children: [
      {
        ...
        component: () => import('@/views/asset_leasing/records/index'),
        meta: { title: '资产租借记录列表', icon: 'table' }
      },
      {
        path: '/asset_leasing/lending',
        name: 'AssetLending',
        component: () => import('@/views/asset_leasing/asset_lending/index'),
        meta: { title: '资产借出', icon: 'tree' }
      },
      {
        path: '/asset_leasing/return',
        name: 'AssetReturn',
        component: () => import('@/views/asset_leasing/asset_return/index'),
